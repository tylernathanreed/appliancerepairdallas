@component('components.navbar', [
	'items' => [
		'Home' => config('app.url'),
		'About' => [
			'Style 1' => route('pages.about.style-1'),
			'Style 2' => route('pages.about.style-2'),
			'Style 3' => route('pages.about.style-3'),
			'Style 4' => route('pages.about.style-4')
		],
		'Services' => [
			'Style 1' => route('pages.services.style-1'),
			'Style 2' => route('pages.services.style-2'),
			'Style 3' => route('pages.services.style-3'),
		],
		'Resources' => [
			'Appliances' => route('pages.resources.appliances'),
			'Testimonials' => route('pages.resources.testimonials'),
			'Manufacturer Numbers' => route('pages.resources.manufacturer-numbers'),
			'Coverage' => route('pages.resources.coverage'),
			'Content Sliders' => route('pages.resources.content-sliders')
		],
		'Components' => null,
		'Tips &amp; Tricks' => [
			'Repair Tips' => route('pages.repair-tips'),
			'FAQ' => route('pages.faq')
		],
		'Contact' => [
			'Style 1' => route('pages.contact.style-1'),
			'Style 2' => route('pages.contact.style-2'),
			'Style 3' => route('pages.contact.style-3')
		]
	]
])
