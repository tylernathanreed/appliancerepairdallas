    ...
    <div class="slider-banner-container">
        <div class="slider-banner-fullwidth">
            <ul class="slides">
                ...
                <!-- main image -->
                <img src="{{ asset('media/images/slideshow-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
                ...
                <div class="tp-caption sfb fadeout large_white"
                    ...
                    data-speed="500"
                    data-start="1000"
                    data-easing="easeOutQuad">E&amp;M Home Service
                </div>  
                ...
                <div class="tp-caption sfb fadeout medium_white hidden-xs"
                    ...
                    data-endspeed="600">Your #1 source for friendly in-home appliance repair
                </div>
                ...
                <!-- main image -->
                <img src="{{ asset('media/images/slideshow-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
                ...
                <div class="tp-caption sfb fadeout medium_white text-center hidden-xs"
                    ...
                    data-start="1300"
                    data-easing="easeOutQuad"
                    data-endspeed="600">We will not nickle and dime you to drive up your bill
                </div>
